...
function StatsSection() {
  ...
  return (
    <section ref={ref} className="py-16 bg-white dark:bg-[#0a0a0a]">
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#0a0a0a]">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            >
              ...
              <motion.p
                ...
                className="text-lg text-green-100 mb-8 max-w-xl mx-auto lg:mx-0 leading-relaxed"
              >
              ...
              >
                {['⚡ 24hr Response', '🛡️ Safe & Secure', '🌿 Eco-Friendly', '🏆 Ford Authorised'].map((badge, i) => (
                  <motion.span
                    key={i}
      ...
      {/* ── HOW IT WORKS ─────────────────────────────── */}
      <section id="how-it-works" className="py-24 bg-gray-50 dark:bg-[#111111]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                whileHover={{ y: -8 }}
                className={`relative text-center p-8 ${item.color} border-2 rounded-2xl hover:shadow-xl transition duration-300`}
              >
                <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-white dark:bg-[#1a1a1a] border-2 border-green-200 rounded-full w-8 h-8 flex items-center justify-center text-xs font-bold text-[#1B4332]">
                  {item.step}
                </div>
                ...
                {item.btn && (
                  <Link
                    href={item.btnHref!}
                    className="inline-flex items-center gap-1 text-[#1B4332] dark:text-green-400 font-semibold hover:text-[#2D6A4F] transition"
                  >
                    {item.btnText}
                  </Link>
                )}
      ...
      {/* ── WHY CHOOSE US ────────────────────────────── */}
      <section id="why-us" className="py-24 bg-white dark:bg-[#0a0a0a]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <motion.div
                ...
                className={`relative text-center p-6 bg-white dark:bg-[#1a1a1a] border-2 border-gray-100 dark:border-gray-800 rounded-2xl shadow-sm ${feature.color} transition duration-300 hover:shadow-xl cursor-default`}
              >
                <span className={`absolute top-3 right-3 text-xs font-semibold px-2 py-1 rounded-full ${feature.badgeColor}`}>
                  {feature.badge}
                </span>
      ...
      {/* ── CONTACT SECTION ──────────────────────────── */}
      <section id="contact" className="py-24 bg-gray-50 dark:bg-[#111111]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-6">
              <motion.div
                ...
                viewport={{ once: true }}
                className="flex items-center gap-5 bg-green-50 dark:bg-green-900/20 border-2 border-green-200 dark:border-green-800 rounded-2xl p-5 hover:shadow-md transition duration-300"
              >
                <div className="w-14 h-14 bg-[#1B4332] rounded-xl flex items-center justify-center text-2xl shadow-md flex-shrink-0">📞</div>
                <div>
                  <div className="font-bold text-gray-900 dark:text-white text-lg">Phone</div>
                  <div className="text-[#1B4332] dark:text-green-400 font-semibold text-base">Michelle Ridenour</div>
                  <a href="tel:+12489127995" className="text-[#2D6A4F] dark:text-green-300 font-medium hover:text-[#1B4332] transition text-sm">
                    +1 (248) 912-7995
                  </a>
                </div>
              </motion.div>
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className="flex items-start gap-5 bg-emerald-50 dark:bg-emerald-900/20 border-2 border-emerald-200 dark:border-emerald-800 rounded-2xl p-5 hover:shadow-md transition duration-300"
              >
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className="flex items-start gap-5 bg-teal-50 dark:bg-teal-900/20 border-2 border-teal-200 dark:border-teal-800 rounded-2xl p-5 hover:shadow-md transition duration-300"
              >
                <div className="w-14 h-14 bg-[#52B788] rounded-xl flex items-center justify-center text-2xl shadow-md flex-shrink-0">📍</div>
                <div className="flex-1">
                  <div className="font-bold text-gray-900 dark:text-white text-lg">Location</div>
                  <div className="text-[#1B4332] dark:text-green-400 font-semibold mb-2">Pan United States</div>
                  <div className="flex flex-wrap gap-2 mb-2">
                    {['🏙️ Michigan', '🌆 Texas', '🏛️ California', '🌇 Florida', '🏢 New York', '+ More States'].map((state, i) => (
                      <span key={i} className="bg-teal-100 dark:bg-teal-900/40 text-teal-700 dark:text-teal-300 text-xs font-semibold px-2 py-1 rounded-full">
                        {state}
                      </span>
                    ))}
                  </div>
                  <p className="text-gray-500 dark:text-gray-400 text-sm">
                    Serving all major Ford dealerships and fleet operators across the US
                  </p>
                </div>
              </motion.div>
            </div>
            ...
            <motion.div
              ...
              transition={{ duration: 0.5 }}
              viewport={{ once: true }}
              className="bg-gradient-to-br from-[#1B4332] to-[#0D2B1F] rounded-3xl p-10 text-white shadow-2xl text-center"
            >
              ...
              <p className="text-green-200 mb-8 leading-relaxed">
                Login to your customer account to schedule a scrap vehicle pickup. It only takes 2 minutes!
              </p>

              <Link
                href="/login/requestor"
                className="inline-block bg-white text-[#1B4332] px-10 py-4 rounded-xl font-bold text-lg hover:bg-green-50 shadow-xl transform hover:scale-105 transition duration-300 mb-6 w-full text-center"
              >
              ...
              <div className="flex justify-center pt-6 border-t border-white/20 mt-6">
                <button
                  ...
                  className="text-green-200 hover:text-white text-sm font-medium transition"
                >
                  Admin Login →
                </button>
              </div>
      ...
      <section className="py-20 bg-gradient-to-r from-[#1B4332] to-[#2D6A4F] text-white">
        ...
        >
          <div className="w-16 h-16 bg-white/10 rounded-2xl flex items-center justify-center text-3xl mx-auto mb-6 border border-white/20">🌿</div>
          <h2 className="text-4xl md:text-5xl font-bold mb-6">Ready to Schedule Your Pickup?</h2>
          <p className="text-xl text-green-100 mb-8">Login to your customer account to get started today!</p>
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
            <Link
              href="/login/requestor"
              className="inline-block bg-white text-[#1B4332] px-10 py-5 rounded-xl font-bold text-xl hover:bg-green-50 shadow-2xl transition duration-300"
            >
      ...
      <footer className="bg-[#0D2B1F] text-white pt-16 pb-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
            ...
            <div className="col-span-1">
              ...
              <p className="text-green-400/70 text-sm leading-relaxed">
                Professional scrap pickup service for Ford vehicles across the United States. Authorised and trusted Ford partner.
              </p>
              <div className="mt-4 inline-flex items-center gap-2 bg-green-900/50 border border-green-700 rounded-full px-3 py-1">
                <span className="text-sm">🌿</span>
                <span className="text-green-300 text-xs font-medium">Eco-Friendly Service</span>
              </div>
            </div>
              ...
              <ul className="space-y-3">
                {[
                  ...
                  <li key={link.label}>
                    <Link
                      href={link.href}
                      className="text-green-400/70 hover:text-white text-sm transition duration-200 inline-block hover:translate-x-1"
                    >
                      → {link.label}
                    </Link>
                  </li>
            ...
            <div>
              ...
              <ul className="space-y-3 text-green-400/70 text-sm">
                {['FAQ', 'Contact Us', 'Terms & Conditions', 'Privacy Policy'].map(item => (
                  <li key={item} className="hover:text-white cursor-pointer transition hover:translate-x-1 inline-block">
                    → {item}
                  </li>
                ))}
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-3 text-green-400/70 text-sm">
                <li className="flex items-center gap-2"><span>👤</span><span className="text-white font-medium">Michelle Ridenour</span></li>
                <li className="flex items-center gap-2"><span>📞</span><a href="tel:+12489127995" className="hover:text-white transition">+1 (248) 912-7995</a></li>
                <li className="flex items-center gap-2"><span>📧</span><a href="mailto:fcscats@ford.com" className="hover:text-white transition">fcscats@ford.com</a></li>
                <li className="flex items-center gap-2"><span>📧</span><a href="mailto:fcsmktg@ford.com" className="hover:text-white transition">fcsmktg@ford.com</a></li>
                <li className="flex items-center gap-2"><span>📍</span><span>Pan United States</span></li>
              </ul>
            </div>
          ...
          {/* Bottom Bar */}
          <div className="border-t border-green-900 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-green-400/60 text-sm">
              © {new Date().getFullYear()} Ford Component Sales. All rights reserved.
            </p>
            <div className="flex items-center gap-3">
              <FordLogo height={20} />
              <span className="text-green-400/60 text-xs">An Authorised Ford Partner</span>
            </div>
          </div>
        </div>
      </footer>
