...
export async function POST(request: NextRequest) {
  try {
    ...
    // Determine if this is for admin or requestor
    const isAdmin = to.includes('admin') || subject.includes('New Pickup Request')
      ...
      <html>
        <head>
          <style>
            ...
            .info-section { background: white; padding: 20px; margin: 15px 0; border-radius: 8px; border-left: 4px solid #1e40af; }
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              <p>Hello Admin,</p>
              <p>A new scrap pickup request has been submitted. Please review the details below:</p>
              
              <div class="info-section">
                <h3 style="margin-top: 0; color: #1e40af;">📋 RCRC Information</h3>
                <div class="info-row">
                ...
                <div class="info-row">
                  ...
                  <span class="value">${rcrcContactPerson || 'N/A'}</span>
                </div>
                <div class="info-row">
                ...
                <div class="info-row">
                  ...
                  <span class="value">${rcrcPhoneNumber || 'N/A'}</span>
                </div>
              </div>

              <div class="info-section">
                <h3 style="margin-top: 0; color: #1e40af;">📍 Pickup Location</h3>
                <div class="info-row">
                  <span class="label">Address 1:</span>
                  <span class="value">${rcrcAddress || 'N/A'}</span>
                </div>
                ${rcrcAddress2 ? `
                <div class="info-row">
                ...
                <div class="info-row">
                  ...
                  <span class="value">${rcrcZipCode || 'N/A'}</span>
                </div>
              </div>

              <div class="info-section">
                <h3 style="margin-top: 0; color: #1e40af;">📅 Schedule</h3>
                <div class="info-row">
                  <span class="label">Preferred Date:</span>
                  <span class="value">${preferredDate || 'N/A'}</span>
                </div>
                <div class="info-row">
                  <span class="label">Time Window:</span>
                  <span class="value">${pickupHours || 'N/A'}</span>
                </div>
              </div>

              <div class="info-section">
                <h3 style="margin-top: 0; color: #1e40af;">📦 Quantities</h3>
                <div class="info-row">
                  <span class="label">Pallet Quantity:</span>
                  <span class="value">${palletQuantity || 0}</span>
                </div>
                <div class="info-row">
                  <span class="label">Total Pieces:</span>
                  <span class="value">${totalPiecesQuantity || 0}</span>
                </div>
              </div>
              ...
              <div style="text-align: center;">
                <a href="${process.env.NEXT_PUBLIC_APP_URL || 'http://localhost:3000'}/login/admin" class="button">
                  View in Dashboard
                </a>
              </div>
            </div>
            <div class="footer">
              <p>Ford Component Sales - Scrap Pickup Management System</p>
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <p>Thank you for submitting your scrap pickup request. We have received your request and will process it shortly.</p>
              
              <div class="info-section">
                <h3 style="margin-top: 0; color: #10b981;">📋 Request Summary</h3>
                <div class="info-row">
                  <span class="label">RCRC Number:</span>
                  <span class="value">${rcrcNumber || 'N/A'}</span>
                </div>
                ...
                <div class="info-row">
                  ...
                  <span class="value">${rcrcAddress}, ${state} ${rcrcZipCode}</span>
                </div>
                <div class="info-row">
                  <span class="label">Pallet Quantity:</span>
                  <span class="value">${palletQuantity || 0}</span>
              ...
              <div style="background: #fef3c7; padding: 15px; border-radius: 8px; margin: 20px 0; border-left: 4px solid #f59e0b;">
                <h4 style="margin-top: 0; color: #92400e;">⏱️ What's Next?</h4>
              ...
              <div style="background: #dbeafe; padding: 15px; border-radius: 8px; margin: 20px 0; border-left: 4px solid #2563eb;">
                ...
                <p style="margin: 0; color: #1e3a8a;">
                  Contact us at <strong>support@fordcomponentsales.in</strong><br>
                  or call <strong>+91 1800-XXX-XXXX</strong>
                </p>
              </div>
            </div>
            <div class="footer">
