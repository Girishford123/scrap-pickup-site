              ...
              <div className="flex items-center
                ...
                {activeTab === tab.key && (
                  <span className={`text-xs font-bold
                    ${tab.color} bg-white/70 px-2 py-0.5
                    rounded-full`}>
                    Active
                  </span>
                )}
          ...
          <div className="text-center py-20">
            ...
            {searchQuery && (
              <button
                ...
                className="mt-4 text-sm text-[#003478]
